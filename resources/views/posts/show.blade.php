                    ...
                    @auth
                        <x-panel>
                            <form action="/posts/{{ $post->slug }}/comments" method="post">
                                ...
                                <div class="mt-6">
                                    <textarea name="body" rows="5" class="w-full text-sm focul:outline-none focus:ring" placeholder="Quick, thing to say"></textarea>
                                </div>

                                <div class="flex justify-end mt-6 pt-6 border-t border-gray-200">
                                    <button type="submit" class="
                                        bg-blue-500 text-white uppercase font-semibold text-xs py-2 px-10 rounded-2xl
                                        hover:bg-blue-600
                                    ">Post</button>
                                </div>
                            </form>

    ...
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
            ...
            <form action="/register" method="post" class="mt-10">
                ...
                <div class="mb-6">
                    <label for="name" class="block mb-2 uppercase font-bold text-xs text-grey-700">
                        Name
                    </label>
                ...
                <div class="mb-6">
                    <label for="username" class="block mb-2 uppercase font-bold text-xs text-grey-700">
                        Username
                    </label>
